...
// Returns the private 'App\Repository\UserSystemesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserSystemesRepository.php';

return $this->privates['App\\Repository\\UserSystemesRepository'] = new \App\Repository\UserSystemesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
