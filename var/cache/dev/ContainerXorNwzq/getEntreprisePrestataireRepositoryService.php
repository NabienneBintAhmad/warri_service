...
// Returns the private 'App\Repository\EntreprisePrestataireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EntreprisePrestataireRepository.php';

return $this->privates['App\\Repository\\EntreprisePrestataireRepository'] = new \App\Repository\EntreprisePrestataireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
