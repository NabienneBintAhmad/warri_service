...
// Returns the private 'App\Repository\UserPrestataireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserPrestataireRepository.php';

return $this->privates['App\\Repository\\UserPrestataireRepository'] = new \App\Repository\UserPrestataireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
