...
// Returns the private 'App\Repository\ComptePrestataireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComptePrestataireRepository.php';

return $this->privates['App\\Repository\\ComptePrestataireRepository'] = new \App\Repository\ComptePrestataireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
