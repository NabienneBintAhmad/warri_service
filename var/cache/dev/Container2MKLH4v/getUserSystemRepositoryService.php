...
// Returns the private 'App\Repository\UserSystemRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserSystemRepository.php';

return $this->privates['App\\Repository\\UserSystemRepository'] = new \App\Repository\UserSystemRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
